                ...
                <div class="block-section">
                    <table id="example-datatables" class="table table-bordered table-hover">
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                <td class="span1 text-center hidden-phone"><?php echo ($v["CategoryApartmentId"]); ?></td>
                                <td><a href="javascript:void(0)"><?php echo ($v["Name"]); ?></a></td>
                                <td class="hidden-phone hidden-tablet">
                                  <?php if(($v["IsLocked"] == 1)): ?><i class="icon-lock"></i>&nbsp;&nbsp;开放 <?php else: ?> <i class="icon-unlock"></i>&nbsp;&nbsp;未开放<?php endif; ?>
                                </td>
