                                    ...
                                    <li>
                                        ...
                                        <ul>  
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="icon-list"></i>总后台用户列表</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/work');?>">在职人员</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/dimission');?>">离职人员</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/user');?>"><i class="icon-edit"></i>添加总后台用户</a>
                                                    </li> 
                                                </ul>
                                            </li>
                                            <!-- 权限动作管理 -->
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="icon-list"></i>权限动作列表</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/work');?>"><i class="icon-edit"></i>添加权限动作</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <!-- 权限模块管理 -->
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="icon-list"></i>权限模块列表</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/work');?>"><i class="icon-edit"></i>添加权限模块</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        <!-- 权限角色管理 -->
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="icon-list"></i>权限角色列表</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/work');?>"><i class="icon-edit"></i>添加权限角色</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <!-- 省份管理 -->
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="icon-list"></i>省份列表</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/work');?>"><i class="icon-edit"></i>添加省份</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        <!-- 城市管理 -->
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="icon-list"></i>城市列表</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/work');?>"><i class="icon-edit"></i>添加城市</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        <!-- 区县管理 -->
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="icon-list"></i>区县列表</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/work');?>"><i class="icon-edit"></i>添加区县</a>
                                                    </li>
                                                </ul>
                                            </li>
                                             <!-- 房屋类型管理 -->
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="icon-list"></i>房屋类型列表</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/work');?>"><i class="icon-edit"></i>添加房屋类型</a>
                                                    </li>
                                                </ul>
                                            </li>
                                             <!-- 造价预算管理 -->
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="icon-list"></i>造价预算列表</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/work');?>"><i class="icon-edit"></i>添加造价预算</a>
                                                    </li>
                                                </ul>
                                            </li>
                                             <!-- 设计风格管理 -->
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="icon-list"></i>设计风格列表</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/work');?>"><i class="icon-edit"></i>添加设计风格</a>
                                                    </li>
                                                </ul>
                                            </li>
                                             <!-- 设计专长管理 -->
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="icon-list"></i>设计专长列表</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo U(GROUP_NAME.'/User/work');?>"><i class="icon-edit"></i>添加设计专长</a>
                                                    </li>
                                                </ul>
                                            </li>
                    ...
                    <table id="example-datatables" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="hidden-phone hidden-tablet"><i class="icon-lock bigger-110 hidden-480"></i>&nbsp;&nbsp;</i>是否锁定</th>
