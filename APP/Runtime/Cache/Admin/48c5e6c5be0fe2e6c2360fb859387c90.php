            ...
            <div id="page-content">
                ...
                <div class="block block-themed">
                    ...
                    <div class="block-content">
                        <form action="<?php echo U(GROUP_NAME.'/Province/add');?>" method="post" class="form-inline" >
                            <!-- div.row-fluid -->
                            <div class="row-fluid">
                                <!-- 1st Column -->
                                <div class="span6">
                                    <div class="control-group">
                                        <label class="control-label" for="columns-text">省份名</label>
                                        <div class="controls">
                                            <input type="text" id="columns-text" name="ProvinceName" >
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="columns-password">省份拼音简称</label>
                                        <div class="controls">
                                            <input type="text" id="columns-password" name="ProvinceSimpName">
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
