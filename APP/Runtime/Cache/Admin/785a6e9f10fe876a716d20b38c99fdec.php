                ...
                <div class="block-section">
                    <table id="example-datatables" class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                <td class="span1 text-center hidden-phone"><?php echo ($v["ProvinceId"]); ?></td>
                                <td><a href="javascript:void(0)"><?php echo ($v["ProvinceName"]); ?></a></td>
                                <td class="span1 text-center"><?php echo ($v["ProvinceSimpName"]); ?></td>
                                <td class="hidden-phone hidden-tablet"><?php echo ($v["IsOpen"]); ?></td>
