                                            ...
                                            <ul>                                        
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="<?php echo U(GROUP_NAME.'/User/adduser');?>"><i class="icon-edit"></i>添加总后台用户</a>
                                                        </li> 
                                                    </ul>
                                                </li>
                                            
                                                <li>
                                                    <a href="#" class="submenu-link">哈哈哈<span>555</span></a>
                                                    <ul>
                                                        <li>
                ...
                <div class="block-section">
                    <table id="example-datatables" class="table table-bordered table-hover">
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td><a href="javascript:void(0)"><?php echo ($v["UserName"]); ?></a></td>
                                <td class="hidden-phone hidden-tablet"><?php echo ($v["IsLocked"]); ?><i class="icon-unlock"></i>未锁定</td>
