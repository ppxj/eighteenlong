                    ...
                    <table id="example-datatables" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="span2 hidden-phone"><i class="icon-user"></i>&nbsp;&nbsp;城市名</th>
                                <th class="span2 hidden-phone">城市简称</th>
...
<select class='ProvinceId' id="ProvinceId" name="ProvinceId" onchange="window.location.href='<?php echo U(GROUP_NAME.'/City/index/');?>">
              ...
              <a href="<?php echo U(GROUP_NAME.'/City/index/',array('ProvinceId'=>5));?>">mark</a>             
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                <td class="span1 text-center hidden-phone"><?php echo ($v["CityId"]); ?></td>
                                <td><a href="javascript:void(0)"><?php echo ($v["CityName"]); ?></a></td>
                                <td class="span1 text-center"><?php echo ($v["CitySimpName"]); ?></td>
